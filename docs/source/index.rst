...
This BalderHub project provides basic features for communicating with programmable test devices over the SCPI standard.

.. note::
   Please note, this package is still under development. If you would like to contribute, take a look into the
   `project <https://github.com/balder-dev/balderhub-scpi/>`_.
